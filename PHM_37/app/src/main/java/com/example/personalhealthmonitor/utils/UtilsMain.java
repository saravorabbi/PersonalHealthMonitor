...
public class UtilsMain {
    ...
    public static void addDBElements(){
        ...
        Info info1 = new Info(UUID.randomUUID().toString(), 36, 120, 80, 90, 70, "Primo Report!", "01/02/2021");
        infoViewModel.insert(info1);
        Info info2 = new Info(UUID.randomUUID().toString(), 35.7, 0.0, 84, 0.0, 70.2, "Secondo Report!", "01/03/2021");
        infoViewModel.insert(info2);
        Info info3 = new Info(UUID.randomUUID().toString(), 0.0, 124, 86, 96, 0.0, "Terzo Report!", "01/05/2021");
        infoViewModel.insert(info3);
        Info info4 = new Info(UUID.randomUUID().toString(), 37.2, 0.0, 0.0, 98, 69.8, "Quarto Report!", "01/13/2021");
        infoViewModel.insert(info4);
        Info info5 = new Info(UUID.randomUUID().toString(), 36.8, 115, 82, 88, 70.1, "Quinto Report!", "01/07/2021");
        infoViewModel.insert(info5);
        Info info6 = new Info(UUID.randomUUID().toString(), 0.0, 116, 81, 102, 0.0, "Sesto Report!", "01/08/2021");
        ...
        Info info11 = new Info(UUID.randomUUID().toString(), 0.0, 0.0, 82, 91, 70.9, "", "01/23/2021");
