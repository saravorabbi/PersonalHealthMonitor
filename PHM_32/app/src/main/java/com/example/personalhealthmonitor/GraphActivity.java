...
//        barEntryArrayListTemp = new ArrayList<>();
        ...
        infoViewModelGraph.getReportFromTemperature().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> tempList) {
                ...
                lineChartTemp.animateY(2000); //tempo dell'animazione del grafo
                ...
                barChartTemp.animateY(2000);    //tempo dell'animazione del grafo
        ...
        infoViewModelGraph.getReportFromPressioneSistolica().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> pressList) {
                ...
                lineChartPressSis.animateY(2000); //tempo dell'animazione del grafo
                ...
                barChartPressSis.animateY(2000);    //tempo dell'animazione del grafo
        ...
        infoViewModelGraph.getReportFromPressioneDiastolica().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> pressList) {
                ...
                lineChartPressDia.animateY(2000); //tempo dell'animazione del grafo
                ...
                barChartPressDia.animateY(2000);    //tempo dell'animazione del grafo
        ...
        infoViewModelGraph.getReportFromGlicemia().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> glicList) {
                ...
                lineChartGlicemia.animateY(2000); //tempo dell'animazione del grafo
                ...
                barChartGlicemia.animateY(2000);    //tempo dell'animazione del grafo
        ...
        infoViewModelGraph.getReportFromPeso().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> pesoList) {
                ...
                lineChartPeso.animateY(2000); //tempo dell'animazione del grafo
                ...
                barChartPeso.animateY(2000);    //tempo dell'animazione del grafo
