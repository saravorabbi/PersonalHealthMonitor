    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toggleBool){
            ...
            if(!dailyTime.equals(DAILY_TIME_DEFAULT)){
                ...
                Log.i(TAG, "DAILY_TIME INIZIALIZZATA" );
        ...
        Log.i(TAG, "NOTIFICATION_ON = " + String.valueOf(isTimeON1));

        boolean isRepoAdded1 = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(NEW_REPORT, true);
        Log.i(TAG, "ADDED_REPO = " + String.valueOf(isRepoAdded1));
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( toggleButton.isChecked() ){
                    ...
                    Log.i(TAG, "NOTIFICATION_ON = " + String.valueOf(isTimeON2));

                    boolean isRepoAdded2 = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(NEW_REPORT, true);
                    Log.i(TAG, "ADDED_REPO = " + String.valueOf(isRepoAdded2));
