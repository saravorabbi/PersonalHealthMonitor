...
import static com.example.personalhealthmonitor.MainActivity.MONITORA_GLIC;
import static com.example.personalhealthmonitor.MainActivity.MONITORA_PRESS_DIA;
import static com.example.personalhealthmonitor.MainActivity.MONITORA_PRESS_SIS;
import static com.example.personalhealthmonitor.MainActivity.MONITORA_TEMP;
            ...
            if( updateVal > 2) {
                ...
                if (updateLowBound < updateUpBound) {
                    ...
                    if( Utils.checkDateSettings(updateBeginDate, updateEndDate) ){
                        ...
                        else if(i == 5) getSharedPreferences(SHARED_PREF, MODE_PRIVATE).edit().putBoolean(MONITORA_GLIC, true).apply();
...
//        }
    ...
    private void startNewJobService() {
        ...
        JobInfo info = new JobInfo.Builder(123, componentName)
                .setPersisted(true)
                .setPeriodic(15 * 60 *1000) //TODO setta il periodo 24h e fai avenire il Job alle 2:00 di notte
                .build();
