...
public class UtilsMain {
    ...
    public static void addDBElements(){
        ...
        Info info1 = new Info(UUID.randomUUID().toString(), 36, 0.0, 0.0, 90, 70, "Primo Report!", "01/03/2021");
        infoViewModel.insert(info1);
        Info info2 = new Info(UUID.randomUUID().toString(), 35.7, 0.0, 84, 0.0, 70.2, "Secondo Report!", "01/06/2021");
        infoViewModel.insert(info2);
        Info info3 = new Info(UUID.randomUUID().toString(), 0.0, 124, 86, 96, 0.0, "Terzo Report!", "01/07/2021");
        infoViewModel.insert(info3);
        Info info4 = new Info(UUID.randomUUID().toString(), 37.2, 0.0, 0.0, 98, 69.8, "Quarto Report!", "01/09/2021");
        infoViewModel.insert(info4);
        Info info5 = new Info(UUID.randomUUID().toString(), 0.0, 115, 82, 0.0, 0.0, "Quinto Report!", "01/11/2021");
        infoViewModel.insert(info5);
        Info info6 = new Info(UUID.randomUUID().toString(), 0.0, 116, 81, 102, 0.0, "Sesto Report!", "01/14/2021");
        infoViewModel.insert(info6);
        Info info7 = new Info(UUID.randomUUID().toString(), 36.1, 0.0, 80, 0.0, 70.5, "Settimo Report!", "01/16/2021");
        infoViewModel.insert(info7);
        Info info8 = new Info(UUID.randomUUID().toString(), 35.8, 0.0, 85, 0.0, 70.4, "Ottavo Report!", "01/18/2021");
        infoViewModel.insert(info8);
        Info info9 = new Info(UUID.randomUUID().toString(), 0.0, 119, 78, 85, 0.0, "Nono Report!", "01/20/2021");
        infoViewModel.insert(info9);
        Info info10 = new Info(UUID.randomUUID().toString(), 36.3, 0.0, 80, 97, 70.2, "Decimo Report!", "01/21/2021");
        infoViewModel.insert(info10);
        Info info11 = new Info(UUID.randomUUID().toString(), 0.0, 0.0, 0.0, 91, 70.9, "Glicemia sotto controllo", "01/23/2021");
