...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DATE = cal.getInstance().get(Calendar.DAY_OF_MONTH);


        toggleButton.setChecked( getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(IS_TIME_ON, true) );
        isTimeCheck = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(IS_TIME_ON, true);
        Log.i(TAG, "Apertuta settings IS_TIME_ON = " + String.valueOf(isTimeCheck));
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(view.getContext(), new TimePickerDialog.OnTimeSetListener(){
                    ...
                    public void onTimeSet(TimePicker timePicker, int ore, int minuti) {
                        ...
                        //TODO updateTmeText(calendar)
                        //     startAlarm(calendar)


                        timeTW.setText(ore + ":" + minuti);
                    }
                }, HOUR, MINUTE, true);
