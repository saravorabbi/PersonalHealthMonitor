...
public class GraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //id view grafo
        TextView lineChartTV = findViewById(R.id.show_line_chart);
        TextView barChartTV = findViewById(R.id.show_bar_chart);
        ...
        //TEMPERATURA
        infoViewModel.getReportFromTemperature().observe(this, tempList -> {

            ArrayList<BarEntry> barEntryArrayListTemp = new ArrayList<>();
            ArrayList<Entry> lineEntryArrayListTemp = new ArrayList<>();

            ArrayList<String> asseXBarArrayList = new ArrayList<>();
            ...
            for(int i = 0; i < tempList.size(); i++){
                ...
                Log.i(TAG, "DATA TEMPERATURA = " + dataDB);
        ...
        //PRESSIONE SISTOLICA
        infoViewModel.getReportFromPressioneSistolica().observe(this, pressList -> {
        ...
        infoViewModel.getReportFromPressioneDiastolica().observe(this, pressList -> {
        ...
        //GLICEMIA
        infoViewModel.getReportFromGlicemia().observe(this, glicList -> {
        ...
        //PESO
        infoViewModel.getReportFromPeso().observe(this, pesoList -> {
        ...
        lineChartTV.setOnClickListener(view -> {
        ...
        barChartTV.setOnClickListener(view -> {
