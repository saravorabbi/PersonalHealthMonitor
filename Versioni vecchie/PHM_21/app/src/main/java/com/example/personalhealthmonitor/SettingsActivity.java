...
import static com.example.personalhealthmonitor.MainActivity.IS_TIME_ON;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setto il toggle
        boolean toggleBool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(IS_TIME_ON, true);
        toggleButton.setChecked(toggleBool);
        Log.i(TAG, "IS_TIME_ON (notifica on TRUE, notifica off FALSE)=  " + String.valueOf(toggleBool));
...
//                    isTimeCheck = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(IS_TIME_ON, true);
//                    Log.i(TAG, "IS_TIME_ON = " + String.valueOf(isTimeCheck));
                    Log.i(TAG, "Disattivo la notifica e cancello le notifiche attive");
...
//                flag = false;
        ...
        if ( toggleButton.isChecked() ){
            ...
            //togli la notifica precedente e metti quella con questo orario
        }

        //TODO il set daily notifiche dovrebbe essere qui, non nel datePicker
