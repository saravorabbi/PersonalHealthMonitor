...
//        barEntryArrayListTemp = new ArrayList<>();
        ...
        infoViewModelGraph.getReportFromPressioneSistolica().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> pressList) {
                ...
                // Line Data Set
                LineDataSet lineDataSetPressSis = new LineDataSet(lineEntryArrayListPessSIS, "Pressione Sistolica");
                ...
                // Bar Data Set
                BarDataSet barDataSetPressSis = new BarDataSet(barEntryArrayListPessSIS, "Pressione Sistolica");
        ...
        infoViewModelGraph.getReportFromPressioneDiastolica().observe(this, new Observer<List<Info>>() {
            ...
            public void onChanged(List<Info> pressList) {
                ...
                // Line Data Set
                LineDataSet lineDataSetPressDia = new LineDataSet(lineEntryArrayListPessDIA, "Pressione Diastolica");
                ...
                // Bar Data Set
                BarDataSet barDataSetPressDia = new BarDataSet(barEntryArrayListPessDIA, "Pressione Diatolica");
