...
//    //filtri
//    @Query("SELECT * FROM report WHERE value IN(:listParameter)")
//    LiveData<List<Info>> getReport(List<String> listParameter);
    ...
    List<String> getParametersFromValue(int priority);
