...
public class SettingsActivity extends AppCompatActivity {
    ...
    public void startTimedNotification(){
        ...
        Log.d(TAG, "La notifica GIORNALIERA arriverà alle ore  = " + oraRemind);


        AlarmManager alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
        //alarmManager.setExact(AlarmManager.RTC_WAKEUP, calendarNotify.getTimeInMillis(), pendingIntent);//todo
    ...
    public void startMonitorNotification(){
        ...
        AlarmManager alarmManager = (AlarmManager) getSystemService(Context.ALARM_SERVICE);
        alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, c.getTimeInMillis(), AlarmManager.INTERVAL_DAY, pendingIntent);//todo
