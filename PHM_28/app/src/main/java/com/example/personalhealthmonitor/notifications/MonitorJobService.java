...
public class MonitorJobService extends JobService {
    ...
    private void doBackgroundWork(JobParameters jobParameters) {
        ...
        new Thread(() -> {
            ...
            int valTemp = settingsViewModelMonitor.getValueFromParameter(TEMPERATURA);
            ...
            int valPresSis = settingsViewModelMonitor.getValueFromParameter(PRESSIONE_SISTOLICA);
            ...
            int valPresDia = settingsViewModelMonitor.getValueFromParameter(PRESSIONE_DIASTOLICA);
            ...
            int valGlicemia = settingsViewModelMonitor.getValueFromParameter(GLICEMIA);
            ...
            int valPeso = settingsViewModelMonitor.getValueFromParameter(PESO);
