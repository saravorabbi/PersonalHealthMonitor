...
public class ForegroundService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i(TAG, "ON START COMMAND - FOREGROUND SERVICE - chiama ogni volta che chiamo startService nella main ativity");
    ...
    private void doBackgroundWork(){
        ...
        new Thread(() -> {
            ...
            if (valTemp >= 3 ) {
                ...
                boolean bool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(EXCEEDED_TEMP, true); //todo
            ...
            if(valPresSis >= 3) {
                ...
                boolean bool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(EXCEEDED_PRESS_SIS, true); //todo
            ...
            if(valPresDia >= 3) {
                ...
                boolean bool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(EXCEEDED_PRESS_DIA, true); //todo
            ...
            if(valGlicemia >= 3) {
                ...
                boolean bool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(EXCEEDED_GLIC, true); //todo
            ...
            if(valPeso >= 3) {
                ...
                boolean bool = getSharedPreferences(SHARED_PREF, MODE_PRIVATE).getBoolean(EXCEEDED_PESO, true); //todo
...
//            Log.d(TAG, "La notifica arriverà alle ore  = " + oraRemind);
            ...
            //dismiss del foreground service quando finisco il lavoro nel thread
            stopSelf();
